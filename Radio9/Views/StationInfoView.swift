...
struct StationInfoView: View {
    ...
    var body: some View {
        HStack(spacing: 15) {
            ...
            // Power indicator
            PowerIndicator(isPlaying: isPlaying, isLoading: isLoading)
...
struct PowerIndicator: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .fill(isLoading ? Color(red: 1.0, green: 0.9, blue: 0.7) : (isPlaying ? Color(red: 0.2, green: 0.8, blue: 0.2) : Color(red: 0.3, green: 0.3, blue: 0.3)))
                .frame(width: 10, height: 10)
                .opacity(isLoading ? (pulseAnimation ? 0.3 : 0.7) : 1.0)
        ...
        .shadow(color: isLoading ? Color(red: 1.0, green: 0.9, blue: 0.7) : (isPlaying ? Color.green : Color.clear), radius: 8)
